      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-600 focus:border-transparent outline-none transition-all text-gray-900 placeholder-gray-400"
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-500">Secure Admin Login</p>
          </div>
        </div>
